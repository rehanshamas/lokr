...
contract FixedValueLockMock is BaseGovernanceWithUserUpgradable, ERC721Upgradeable {
    ...
    function removeBeneficiaries(bytes calldata data) external onlyBeneficiaryManager {
        ...
        for(uint256 i; i < IDs.length;){
            (,, uint256 initialAmount,) =  depositManager.getProperties(IDs[i]);
