...
describe("Lock Second Scenario", () => {
    ...
    it("Should deploy Lock with canAddBeneficiaries = true & canTransfer = true and has non-spitable part", async () => {
        // Prepare deploy fee
        ...
        await expect(lockProxy.connect(account4).transferFrom(account4.address, account5.address, 0)).to.be.revertedWith("ERROR: There is locked part.");
