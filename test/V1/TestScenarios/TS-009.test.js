...
describe("TS-009", () => {
  ...
  describe("Lock Scenario 009", () => {
    ...
    it("Should deploy, init and add beneficiaries on initialization", async () => {
      ...
      const amounts = calculateParts([200, 400]);
      const initLockedAmount = convertToBN(200 + 400);
      ...
      let shmKeyPoints =
        [
          ...
          parseInt(shmLockStart) + parseInt(time.duration.days(15))
        ];
    ...
    it("Should Claim after last 5 days 2/2", async () => {
