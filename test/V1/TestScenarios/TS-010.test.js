...
describe("TS-010", () => {
  ...
  describe("Lock Scenario 010", () => {
    ...
    it("Should deploy, init and add beneficiaries on initialization", async () => {
      ...
      const amounts = calculateParts([300, 300]);
      const initLockedAmount = convertToBN(300 + 300);
      ...
      let shmKeyPoints =
        [
          ...
          parseInt(shmLockStart) + parseInt(time.duration.days(20))
        ];
    ...
    it("Should Claim after first 10 days 1/2", async () => {
