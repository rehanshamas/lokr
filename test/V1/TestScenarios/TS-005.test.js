...
describe("TS-005", () => {
  ...
  describe("Lock Scenario 005", () => {
    ...
    it("Should deploy, init and add beneficiaries on initialization", async () => {
      ...
      const amounts = calculateParts([200, 300, 100]);
      const initLockedAmount = convertToBN(200 + 300 + 100);
    ...
    it("Should Claim after first 10 days 1/3", async () => {
      await time.increase(time.duration.days(10));
      let holders = [A, B, C];
      let claimableAmounts = calculateParts([66.6, 100, 33.3]);
    ...
    it("Should Claim after final 10 days 3/3", async () => {
      await time.increase(time.duration.days(10));
      let holders = [A, B, C];
      let claimableAmounts = calculateParts([66.6, 100, 33.3]);
      for (let i = 0; i < holders.length; i++) {
